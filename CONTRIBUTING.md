<!-- Canonical CONTRIBUTING for every *kit. Copy verbatim, then replace contractskit. -->
# Contributing

Thanks for your interest in contractskit. Bug reports, fixes, and small improvements are welcome.
